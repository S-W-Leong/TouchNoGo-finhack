# TNG RiskOps Agent — Internal Strategy

This is the team-facing strategy doc. Public framing lives in [../README.md](../README.md).
Use this file for build order, scope discipline, and the doc map.
...
1. [../README.md](../README.md)
   Use for: public framing, project description, technical details, inspiration.
2. [./internal-strategy.md](./internal-strategy.md) (this file)
   Use for: current call, build order, scope discipline, doc map.
3. [../focus.md](../focus.md)
   Use for: locked v1 focus — hero case, app shape, three routes only.
4. [../focus-spec-plan-v1.md](../focus-spec-plan-v1.md)
   Use for: the spec-to-plan working doc for v1.
5. [./tng-doc-by-shiwei.md](./tng-doc-by-shiwei.md)
   Use for: event rules, judging, schedule, logistics, submission checklist.
6. [./agent-build-brief-v1.md](./agent-build-brief-v1.md)
   Use for: agent build brief.
7. [./demo-core-ui-first.md](./demo-core-ui-first.md)
   Use for: UI-first demo plan.
